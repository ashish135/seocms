...
<script type="text/javascript">
    $(".btn-submit").click(function(e){
        ...
        $.ajax({
           ...
           data:{taskname:taskname, taskdiscription:taskdiscription, leads_id:leads_id , target_date:target_date , status:status , users_id:users_id , "_token": "{{ csrf_token() }}"   },
...
<script type="text/javascript">
    $(".btn-submit-note").click(function(e){
        ...
        $.ajax({
           ...
           data:{note:note, leads_id:leads_id , users_id:users_id , "_token": "{{ csrf_token() }}"   },
