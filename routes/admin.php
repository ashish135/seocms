<?php
    ...
    // Register Admins
    Route::get('/reporting', '\App\Http\Controllers\LeadsController@reporting')->name('reporting');
    Route::get('/reporting/{id}', '\App\Http\Controllers\LeadsController@showreporting');
