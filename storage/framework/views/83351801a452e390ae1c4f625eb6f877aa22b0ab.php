	...
	<?php if( isset($header)): ?>  
		<div class="panel-heading">
			<h3 class="panel-title"><?php echo $__env->yieldContent($as . '_panel_title'); ?>
				...
				<?php endif; ?>
				<div class="panel-control pull-right">
					<a class="panelButton" href="<?php echo $__env->yieldContent($as . '_panel_link'); ?>">Add New</a
				</div>
			</h3>
...
<?php /**PATH /home/atom/Ashish/seocms/resources/views/superadmin/widgets/panel.blade.php ENDPATH**/ ?>